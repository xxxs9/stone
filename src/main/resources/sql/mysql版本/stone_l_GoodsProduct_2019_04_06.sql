...
-- ----------------------------
-- Table structure for a_finance_public_field
-- ----------------------------
DROP TABLE IF EXISTS `a_finance_public_field`;
CREATE TABLE `a_finance_public_field` (
  `PID` varchar(32) NOT NULL,
  `AUDIT_TYPE` int(2) NOT NULL,
  ...
  `SHOULD_PAY` varchar(10) NOT NULL,
  `ACTUAL_PAY` varchar(10) NOT NULL,
  `ARREARA` varchar(10) NOT NULL,
...
-- ----------------------------
-- Table structure for a_finance_public_pay_reveive
-- ----------------------------
DROP TABLE IF EXISTS `a_finance_public_pay_reveive`;
CREATE TABLE `a_finance_public_pay_reveive` (
...
-- ----------------------------
-- Table structure for d_depot_user
-- ----------------------------
DROP TABLE IF EXISTS `d_depot_user`;
CREATE TABLE `d_depot_user` (
  `ID` varchar(255) NOT NULL,
  `DEPOT_ID` varchar(255) NOT NULL,
  `DEPOT_USER_NAME` varchar(255) NOT NULL,
  `IS_WAREHOUSE_SUPERVISOR` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Table structure for d_sys_depot
-- ----------------------------
DROP TABLE IF EXISTS `d_sys_depot`;
CREATE TABLE `d_sys_depot` (
  `ID` varchar(255) NOT NULL,
  `DEPOT_NUMBER` varchar(255) NOT NULL,
  `DEPOT_NAME` varchar(255) NOT NULL,
  `DEPOT_TYPE` varchar(255) DEFAULT NULL,
  `DEPOT_ADDRESS` varchar(255) NOT NULL,
  `DEPOT_DESCRIBE` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Records of d_sys_depot
-- ----------------------------
BEGIN;
INSERT INTO `d_sys_depot` VALUES ('45654654', 'A01', '菜鸟仓', '原料商品', '南京112号', '................');
INSERT INTO `d_sys_depot` VALUES ('dbb902a32d044366a7b7ab4a1a1c68a1', 'A10', '服装仓', '原料商品', '厦门海沧区', '................');
COMMIT;

-- ----------------------------
-- Table structure for d_sys_depot_inventory
-- ----------------------------
DROP TABLE IF EXISTS `d_sys_depot_inventory`;
CREATE TABLE `d_sys_depot_inventory` (
  `ID` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '仓库库存ID',
  `GOODS_TYPE` int(11) NOT NULL COMMENT '货品(原料/成品)',
  `GOODS_ID` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '原料/成品ID',
  `GOODS_NUMBER` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '货品数量',
  `SHIPMENTS_NUMBER` varchar(255) NOT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Table structure for l_GoodsProduct
-- ----------------------------
DROP TABLE IF EXISTS `l_GoodsProduct`;
CREATE TABLE `l_GoodsProduct` (
  `ID` varchar(255) NOT NULL,
  `STYLE1` varchar(255) DEFAULT NULL,
  `BIANHAO` varchar(255) DEFAULT NULL,
  `PICIHAO` varchar(255) DEFAULT NULL,
  ...
  `CHICHUN` varchar(255) DEFAULT NULL,
...
-- ----------------------------
-- Records of l_GoodsProduct
-- ----------------------------
BEGIN;
INSERT INTO `l_GoodsProduct` VALUES ('53b9702f3e81437fbd76a4eaa83ad43d', '其他', 'L040697849971', '1312', '大理石', 'd11', '福州', '白色', '类型1', '10mmX10mmX10mm', '未生产', NULL, NULL, NULL, '大理石地板', '1199');
INSERT INTO `l_GoodsProduct` VALUES ('dcce08b6efb24c14b103f316adb53444', '其他', 'L040624043267', '12121', '玉石', 's12', '福州', '白色', '类型1', '10mmX10mmX10mm', '未生产', NULL, NULL, NULL, '白玉山', '1399');
INSERT INTO `l_GoodsProduct` VALUES ('f8d6a312303d473888f71060c157de8c', '其他', 'L040597849971', '1212', '玉石', 'S11', '福州', '白色', '类型1 ', '100mmX100mmX100mm', '已生产', NULL, NULL, NULL, '寿山石', '1299');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `l_produce_formula` VALUES ('12db3c397bdd48998c5ab4ea7184a48d', '3fae63afb73a42f19b03f5d279f10bd1', '0', '1', 'lennon1', 'FM040602681109', NULL, NULL, '2019-04-05');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `l_produce_formula_detail` VALUES ('4136212db9984996bdc8f7b5331635f8', '12db3c397bdd48998c5ab4ea7184a48d', '1', '1', '0', 'DE040603445642', NULL, NULL);
COMMIT;
...
INSERT INTO `l_produce_plan` VALUES ('d73d475cc4e940cdaad62868d7341b3b', 'f4eb153bc4a84b23ad268ab4266d41ac', '123', NULL, '0', '0', '1', '', '2019-03-29', '2019-03-29', '2019-04-05', NULL, NULL, NULL);
...
INSERT INTO `l_product` VALUES ('dc12af20108b459b8a2168f74b8cdfe0', '力量宝石', '3', '2', '获得无限力量', 'P291554297440989', NULL, NULL, '1', 'gameloft9', NULL);
INSERT INTO `l_product` VALUES ('f4eb153bc4a84b23ad268ab4266d41ac', 'aaaaaa', '4', '3', '111', 'P631554345611271', NULL, NULL, '12', 'gameloft9', NULL);
...
-- ----------------------------
BEGIN;
INSERT INTO `material` VALUES ('1', '大理石', '1', '无', '1', '2019-04-06', '2019-04-06');
COMMIT;
...
INSERT INTO `sys_access_permission_test` VALUES ('6fed5d379c374c0db77b53c6d2989e4a', '/goodsProduct/pageList', 'authc,roleOr[生产部员工,生产部主管,admin]', 443, NULL, 'gameloft9', NULL, NULL, NULL);
...
INSERT INTO `sys_access_permission_test` VALUES ('82f9c71cd84942fcaeee4d309407ad5d', '/product/pageList', 'authc,roleOr[生产部员工,生产部主管,admin]', 367, NULL, 'gameloft9', NULL, NULL, NULL);
...
INSERT INTO `sys_menu_role_test` VALUES ('93e2b2920ffc41b0a03fa76a011af490', '2237f25367364afa84f069a863234750', 'bf9286a4918b4a3c84267b3e2e0fea12', NULL, NULL, NULL, NULL);
...
INSERT INTO `sys_menu_role_test` VALUES ('c862687fb4704e70b78171acec053465', '2237f25367364afa84f069a863234750', 'J/F9-+?', NULL, NULL, NULL, NULL);
...
INSERT INTO `sys_menu_role_test` VALUES ('d93c00e41839406c8768282a3e971125', 'a167bb34292549218fa276a71f1305d9', 'bf9286a4918b4a3c84267b3e2e0fea12', NULL, NULL, NULL, NULL);
INSERT INTO `sys_menu_role_test` VALUES ('e27176e3e19644b2876bb35eb28b196d', '2237f25367364afa84f069a863234750', 'eaceb6783430421090b8f84c57e48df5', NULL, NULL, NULL, NULL);
...
INSERT INTO `sys_menu_role_test` VALUES ('f1964dfa9e874f008686ff493c32f133', 'a167bb34292549218fa276a71f1305d9', 'eaceb6783430421090b8f84c57e48df5', NULL, NULL, NULL, NULL);
...
INSERT INTO `sys_menu_role_test` VALUES ('f3d339ee05e14109aa2935b7cf832dc8', 'a167bb34292549218fa276a71f1305d9', 'J/F9-+?', NULL, NULL, NULL, NULL);
...
INSERT INTO `sys_menu_test` VALUES ('2237f25367364afa84f069a863234750', '产品列表', 'page/system/ProductDepart/allGoodsProduct.html', '/goodsProduct/pageList', 'icon-text', '6-5', NULL, 'c7479de1ef1846d4bbef5aa4c00c18e9', 2, 'gameloft9', NULL, NULL, NULL);
...
INSERT INTO `sys_menu_test` VALUES ('a167bb34292549218fa276a71f1305d9', '加工单列表', 'page/system/ProductDepart/allProduct.html', '/product/pageList', 'icon-text', '6-1', NULL, 'c7479de1ef1846d4bbef5aa4c00c18e9', 1, 'gameloft9', '2019-04-06 08:55:08', NULL, '2019-04-06 08:55:08');
...
INSERT INTO `sys_oper_log_test` VALUES ('39ba6e4cac4b4dce9fcfeb642d5b0442', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'upd', '2019-04-06 00:55:08', '更新菜单');
...
INSERT INTO `sys_oper_log_test` VALUES ('3f5f417c42ed473fb86633ef4ffbff4f', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'upd', '2019-04-06 00:58:02', '更新菜单');
...
INSERT INTO `sys_oper_log_test` VALUES ('40213373437244859642c4217e137364', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'add', '2019-04-06 00:56:22', '添加菜单');
...
INSERT INTO `sys_oper_log_test` VALUES ('575c5df96a1b46a39fe0dc1c8773302d', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'upd', '2019-04-06 00:59:11', '更新菜单');
...
INSERT INTO `sys_oper_log_test` VALUES ('6f5f28c7c3f9491ba9a4eaf56f0b4d59', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'upd', '2019-04-06 02:16:02', '更新用户');
...
INSERT INTO `sys_oper_log_test` VALUES ('b943dfce28154893af9e4f76f3ad7fe6', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'upd', '2019-04-06 00:56:55', '更新菜单');
...
INSERT INTO `sys_oper_log_test` VALUES ('cfb237b676914974bee98dd20c7cde21', '123', 'gameloft9', '0:0:0:0:0:0:0:1', 'upd', '2019-04-06 00:54:20', '更新菜单');
...
INSERT INTO `sys_user_role_test` VALUES ('1879a335936643ab9fe8498682152e1c', '7c6b9dd82aa642ecaeabc6f5677779ba', 'eaceb6783430421090b8f84c57e48df5');
INSERT INTO `sys_user_role_test` VALUES ('1b55714452f549dfa21272add48bede5', '7c6b9dd82aa642ecaeabc6f5677779ba', 'J/F9-+?');
...
INSERT INTO `user_test` VALUES ('7c6b9dd82aa642ecaeabc6f5677779ba', 'lennon1', '7C4A8D09CA3762AF61E59520943DC26494F8941B', '施大雨', '0', '18700001111', NULL, '2722c1aea4f84754ae1a0a03a15f5698', '生产部', '2019-03-18 11:06:53', NULL);
...
-- ----------------------------
-- Table structure for y_material
-- ----------------------------
DROP TABLE IF EXISTS `y_material`;
CREATE TABLE `y_material` (
  `ID` varchar(255) NOT NULL,
  `GOODS_NAME` varchar(255) NOT NULL,
  `GOODS _DESCRIBE` varchar(255) DEFAULT NULL,
  `GOODS _TYPE` varchar(255) NOT NULL,
  `MATERIAL_PRICE` varchar(255) NOT NULL,
  `OBLIGATE1` varchar(255) DEFAULT NULL,
  `OBLIGATE2` varchar(255) DEFAULT NULL,
  `OBLIGATE3` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Table structure for y_material_goods
-- ----------------------------
DROP TABLE IF EXISTS `y_material_goods`;
CREATE TABLE `y_material_goods` (
  `ID` varchar(255) NOT NULL,
  `SUPPLIER_ID` varchar(255) NOT NULL,
  `MATERIAL_ID` varchar(255) NOT NULL,
  `GOODS_PRICE` varchar(255) NOT NULL,
  `OBLIGATE1` varchar(255) DEFAULT NULL,
  `OBLIGATE2` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `OBLIGATE3` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Table structure for y_supplier
-- ----------------------------
DROP TABLE IF EXISTS `y_supplier`;
CREATE TABLE `y_supplier` (
  `ID` varchar(255) CHARACTER SET utf8 NOT NULL,
  `SUPPLIER_NAME` varchar(255) NOT NULL,
  `SUPPLIER_CHARGE_NAME` varchar(255) NOT NULL,
