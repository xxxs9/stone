layui.config({
    ...
    function defineTable() {
        tableIns = table.render({
            elem: '#user-data'
            , height: 415
            , url: $tool.getContext() + 'sysNotify/findAllReply.do' //数据接口
            , method: 'post'
            , page:true //开启分页
            , cols: [[ //表头
                  {type:'numbers',title:'序号',fixed: 'left'},
                  {field: 'creater', title: '登录名', width: '10%'}
                , {field: 'title', title: '姓名', width: '10%'}
                , {field: 'content', title: '手机号码', width: '10%'}
                , {field: 'replyContent', title: '头像', width: '10%'}
