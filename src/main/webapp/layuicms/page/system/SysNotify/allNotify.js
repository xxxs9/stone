layui.config({
    ...
    function defineTable() {
        tableIns = table.render({
            elem: '#user-data'
            , height: 415
            , url: $tool.getContext() + 'sysNotify/NotifyList.do' //数据接口
            , method: 'post'
            , page:true //开启分页
            , cols: [[ //表头
                  /*{type:'creater',title:'创建者',fixed: 'left'},*/
                 {field: 'creater', title: '创建者', width: '10%'}
                  ,{field: 'createTime', title: '创建时间', width: '10%'}
                , {field: 'sendTime', title: '发送时间', width: '10%'}
                , {field: 'receiverId', title: '接收人', width: '10%'}
                , {field: 'state', title: '状态', width: '10%' ,templet: '#stateInfo'}
                , {field: 'senderId', title: '发送者', width: '10%'},
                {field: 'notifyLevel', title: '通知优先级', width: '10%'}
