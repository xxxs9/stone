layui.config({
    ...
    function changeState(){
        ...
        $api.updatestate(req,function (res) {
    ...
    function initUserInfo() {
        ...
        $api.getmessage(req,function (res) {
            var data = res.data;
            $("[name='senderId']").val(data.senderId);
            $("[name='receiverId']").val(data.receiverId);
            $("[name='title']").val(data.sysNotifyInfo.title);
            $("[name='content']").val(data.sysNotifyInfo.content);
            $("[name='sendTime']").val(data.sendTime);
